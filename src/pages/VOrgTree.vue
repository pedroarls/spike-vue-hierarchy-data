<template>
    <div id="app">
        ...
        <div class="tree-wrapper">
            <org-tree :data="data" collapsable :node-render="nodeRender" :expand-all="expandAll" :horizontal="false"
                :props="props" @on-expand="onExpand" @on-node-click="onNodeClick"></org-tree>
        </div>
...
import { data, newData } from '../assets/data'
export default {
    name: 'app',
    data() {
        return {
